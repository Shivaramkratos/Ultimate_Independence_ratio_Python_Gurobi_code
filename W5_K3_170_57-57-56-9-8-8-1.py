...
# This constructs W5cube box K3 using W5squares
    ...
    for i in range(6):
        m.addConstr(x[i,:].sum() + x[i+6,:].sum() + x[i+12,:].sum() <= 29) # each triangle has <=29 in W_5^2
